...
/* Frozen Burnside: commented out these lines */
...
#ifndef _TYPEDEF_Uint64
#define _TYPEDEF_Uint64
typedef unsigned long long		Uint64;		/* �����Ȃ��W�o�C�g���� */
#endif

#ifndef _TYPEDEF_Sint64
#define _TYPEDEF_Sint64
typedef signed long long		Sint64;		/* �������W�o�C�g���� */
#endif
...
#ifndef _TYPEDEF_Uint64
#define _TYPEDEF_Uint64
typedef unsigned __int64		Uint64;		/* �����Ȃ��W�o�C�g���� */
#endif

#ifndef _TYPEDEF_Sint64
#define _TYPEDEF_Sint64
typedef signed __int64			Sint64;		/* �������W�o�C�g���� */
#endif
